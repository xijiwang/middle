...
# result_string = word_transformer("1234")
# print len(result_string)

# result_string = word_transformer("NOUN")
# print len(result_string)

# result_string = word_transformer("VERB")
# print len(result_string)
...
def process_madlib(mad_lib):
    ...
    l = len(mad_lib)
    while idx < l:
        processed += word_transformer(mad_lib[idx:idx + 4])
        if len(word_transformer(mad_lib[idx:idx + 4])) >= 3:
            idx += 4
        else:
            idx += 1
    return processed
